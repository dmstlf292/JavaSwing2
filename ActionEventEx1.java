...
public class ActionEventEx1 extends MFrame implements ActionListener{
	TextField tf;
	...
	public ActionEventEx1() {
		...
		btn1.addActionListener(this);// 소스1 - 인사하기
		btn2.addActionListener(this);// 소스2 - 종료해서 빠져나가기
		//////////////////////////////////////////////////////////
		add("North",tf);
		add(p1);
		add(p2,"South");
	...
	@Override
	public void actionPerformed(ActionEvent e) {// 현재 소스 2개만 연결됨
		//방법 3, command 이용하기
		String s = e.getActionCommand();
		if(s.equals("인사하기")) {// radio로서 group 이용해서 묶어주기
